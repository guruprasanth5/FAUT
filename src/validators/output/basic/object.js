...
var object = function(type,context,schema,path,isParentArray){

	var error = [];

	if(!schema.hasOwnProperty('displayTitle') && !isParentArray && (schema.title !== 'output')){
		error.push({
			message :"type object should have displayTitle key.",
			path    :path
		})
	}
